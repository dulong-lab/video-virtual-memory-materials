...
GetProcessUserDirectoryTableBase(PEPROCESS Process, CR3* UserDirectoryTableBase)
{
    ...
    else if (Version.dwMajorVersion == 12 && Version.dwMinorVersion == 0 && Version.dwBuildNumber == 19045) Offset = 2;
    else return STATUS_NOT_SUPPORTED;
...
GetProcessAddressPolicy(PEPROCESS Process, BOOLEAN* AddressPolicy)
{
    ...
    else if (Version.dwMajorVersion == 10 && Version.dwMinorVersion == 0 && Version.dwBuildNumber == 19045) Offset = 2;
    else return STATUS_NOT_SUPPORTED;
