...
DriverEntry(PDRIVER_OBJECT  DriverObject, PUNICODE_STRING RegistryPath)
{
    ...
    DbgPrint("Cr3 Value=0x%016I64X PPN=0x%016I64X L1pt.Pa=0x%016I64X\n"
        , Cr3.Value
        , Cr3.Fields.PPN
        , L1ptPa.Value
    );
    ...
    for (int n1 = 0; n1 < 512; n1++)
    {
        ...
        DbgPrint("L1pt[%03d] Value=0x%016I64X R/W=%I64d PPN=0x%016I64X L2pt.Pa=0x%016I64X\n"
            , n1
            , L1pt[n1].Value
            , L1pt[n1].Fields.R_W
            , L1pt[n1].Fields.PPN
        ...
        for (int n2 = 0; n2 < 512; n2++)
        {
            ...
            if (L2pt[n2].Fields1GB.PS) {
                ...
                DbgPrint(".. L2pt[%03d] Value=0x%016I64X R/W=%I64d PS=%I64d PPN=0x%016I64X Pa=0x%016I64X\n"
                    , n2
                    , L2pt[n2].Value
                    , L2pt[n2].Fields.R_W
                    , L2pt[n2].Fields.PS
            ...
            DbgPrint(".. L2pt[%03d] Value=0x%016I64X R/W=%I64d PS=%I64d PPN=0x%016I64X L3pt.Pa=0x%016I64X\n"
                , n2
                , L2pt[n2].Value
                , L2pt[n2].Fields.R_W
                , L2pt[n2].Fields.PS
            ...
            for (int n3 = 0; n3 < 512; n3++)
            {
                ...
                if (L3pt[n3].Fields2MB.PS)
                {
                    ...
                    DbgPrint(".. .. L3pt[%03d] Value=0x%016I64X R/W=%I64d PS=%I64d PPN=0x%016I64X Pa=0x%016I64X\n"
                        , n3
                        , L3pt[n3].Value
                        , L3pt[n3].Fields.R_W
                        , L3pt[n3].Fields.PS
                ...
                DbgPrint(".. .. L3pt[%03d] Value=0x%016I64X R/W=%I64d PS=%I64d PPN=0x%016I64X L4pt.Pa=0x%016I64X\n"
                    , n2
                    , L2pt[n2].Value
                    , L2pt[n2].Fields.R_W
                    , L2pt[n2].Fields.PS
                ...
                for (int n4 = 0; n4 < 512; n4++)
                {
                    ...
                    PA Pa = { .Fields2MB.PPN = L3pt[n3].Fields2MB.PPN };
                    DbgPrint(".. .. .. L4pt[%03d] Value=0x%016I64X R/W=%I64d PPN=0x%016I64X Pa=0x%016I64X\n"
                        , n4
                        , L4pt[n4].Value
                        , L4pt[n4].Fields.R_W
                        , L4pt[n4].Fields.PPN
